...
class  MysqrtApi {
public:
    explicit MysqrtApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    virtual ~MysqrtApi() = default;
    void init();
...
private:
    ...
    void mysqrt_api_default_handler(const Pistache::Rest::Request &request, Pistache::Http::ResponseWriter response);
