...
import openapi_client_pyng.models
from openapi_client_pyng import rest
from openapi_client_pyng.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(openapi_client_pyng.models, klass)
