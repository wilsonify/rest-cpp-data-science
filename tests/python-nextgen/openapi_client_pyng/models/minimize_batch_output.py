...
class MinimizeBatchOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinimizeBatchOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinimizeBatchOutput:
        """Create an instance of MinimizeBatchOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MinimizeBatchOutput.parse_obj(obj)

        _obj = MinimizeBatchOutput.parse_obj({
            "x": obj.get("x"),
