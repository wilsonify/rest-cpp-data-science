...
class VectorMeanInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorMeanInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorMeanInput:
        """Create an instance of VectorMeanInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VectorMeanInput.parse_obj(obj)

        _obj = VectorMeanInput.parse_obj({
            "v": obj.get("v"),
            "w": obj.get("w")
        })
        return _obj
