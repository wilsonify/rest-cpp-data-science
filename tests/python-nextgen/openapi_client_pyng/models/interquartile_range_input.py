...
class InterquartileRangeInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    x: Optional[List[StrictFloat]] = None
    __properties = ["x"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InterquartileRangeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InterquartileRangeInput:
        """Create an instance of InterquartileRangeInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InterquartileRangeInput.parse_obj(obj)

        _obj = InterquartileRangeInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
