...
class SquaredDistanceInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SquaredDistanceInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SquaredDistanceInput:
        """Create an instance of SquaredDistanceInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SquaredDistanceInput.parse_obj(obj)

        _obj = SquaredDistanceInput.parse_obj({
            "v": obj.get("v"),
            "w": obj.get("w")
        })
        return _obj
