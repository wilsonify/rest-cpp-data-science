...
class DeMeanInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeMeanInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeMeanInput:
        """Create an instance of DeMeanInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeMeanInput.parse_obj(obj)

        _obj = DeMeanInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
