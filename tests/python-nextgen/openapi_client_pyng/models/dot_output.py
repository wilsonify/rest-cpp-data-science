...
class DotOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DotOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DotOutput:
        """Create an instance of DotOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DotOutput.parse_obj(obj)

        _obj = DotOutput.parse_obj({
            "x": obj.get("x"),
