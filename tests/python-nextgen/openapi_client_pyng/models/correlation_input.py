...
class CorrelationInput(BaseModel):
    ...
    """
    data: Optional[List[List[StrictFloat]]] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorrelationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorrelationInput:
        """Create an instance of CorrelationInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CorrelationInput.parse_obj(obj)

        _obj = CorrelationInput.parse_obj({
            "data": obj.get("data")
        })
        return _obj
