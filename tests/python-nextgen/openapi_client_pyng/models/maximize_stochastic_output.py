...
class MaximizeStochasticOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaximizeStochasticOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaximizeStochasticOutput:
        """Create an instance of MaximizeStochasticOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MaximizeStochasticOutput.parse_obj(obj)

        _obj = MaximizeStochasticOutput.parse_obj({
            "x": obj.get("x"),
