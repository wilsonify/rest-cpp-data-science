...
class MinimizeStochasticInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinimizeStochasticInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinimizeStochasticInput:
        """Create an instance of MinimizeStochasticInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MinimizeStochasticInput.parse_obj(obj)

        _obj = MinimizeStochasticInput.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
