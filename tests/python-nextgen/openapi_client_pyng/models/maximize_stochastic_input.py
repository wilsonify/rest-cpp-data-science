...
class MaximizeStochasticInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    x: Optional[List[List[StrictFloat]]] = None
    y: Optional[List[StrictFloat]] = None
    __properties = ["x", "y"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaximizeStochasticInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaximizeStochasticInput:
        """Create an instance of MaximizeStochasticInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MaximizeStochasticInput.parse_obj(obj)

        _obj = MaximizeStochasticInput.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
