...
class F1ScoreInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> F1ScoreInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> F1ScoreInput:
        """Create an instance of F1ScoreInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return F1ScoreInput.parse_obj(obj)

        _obj = F1ScoreInput.parse_obj({
            "tp": obj.get("tp"),
            "fp": obj.get("fp"),
            "fn": obj.get("fn"),
            "tn": obj.get("tn")
