...
class CovarianceOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CovarianceOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CovarianceOutput:
        """Create an instance of CovarianceOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CovarianceOutput.parse_obj(obj)

        _obj = CovarianceOutput.parse_obj({
            "x": obj.get("x"),
