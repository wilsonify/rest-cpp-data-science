...
class BucketizeInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    point: Optional[StrictFloat] = None
    bucket_size: Optional[StrictFloat] = None
    __properties = ["point", "bucket_size"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketizeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BucketizeInput:
        """Create an instance of BucketizeInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BucketizeInput.parse_obj(obj)

        _obj = BucketizeInput.parse_obj({
            "point": obj.get("point"),
