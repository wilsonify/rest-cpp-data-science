...
class VectorAddInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorAddInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorAddInput:
        """Create an instance of VectorAddInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VectorAddInput.parse_obj(obj)

        _obj = VectorAddInput.parse_obj({
            "v": obj.get("v"),
            "w": obj.get("w")
        })
        return _obj
