...
class GetRowOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRowOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRowOutput:
        """Create an instance of GetRowOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetRowOutput.parse_obj(obj)

        _obj = GetRowOutput.parse_obj({
            "x": obj.get("x"),
