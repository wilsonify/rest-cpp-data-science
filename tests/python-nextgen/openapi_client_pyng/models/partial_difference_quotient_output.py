...
class PartialDifferenceQuotientOutput(BaseModel):
    ...
    result: Optional[StrictFloat] = None
    __properties = ["x", "result"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialDifferenceQuotientOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialDifferenceQuotientOutput:
        """Create an instance of PartialDifferenceQuotientOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PartialDifferenceQuotientOutput.parse_obj(obj)

        _obj = PartialDifferenceQuotientOutput.parse_obj({
            "x": obj.get("x"),
