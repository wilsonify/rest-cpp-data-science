...
class PartialDifferenceQuotientInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    v: Optional[List[StrictFloat]] = Field(None, description="vector")
    i: Optional[StrictFloat] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PartialDifferenceQuotientInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PartialDifferenceQuotientInput:
        """Create an instance of PartialDifferenceQuotientInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PartialDifferenceQuotientInput.parse_obj(obj)

        _obj = PartialDifferenceQuotientInput.parse_obj({
            "v": obj.get("v"),
            "i": obj.get("i"),
            "h": obj.get("h")
        })
