...
class CorrelationMatrixInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorrelationMatrixInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorrelationMatrixInput:
        """Create an instance of CorrelationMatrixInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CorrelationMatrixInput.parse_obj(obj)

        _obj = CorrelationMatrixInput.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
