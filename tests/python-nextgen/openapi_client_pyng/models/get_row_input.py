...
class GetRowInput(BaseModel):
    ...
    row: Optional[StrictFloat] = None
    __properties = ["mat", "row"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetRowInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetRowInput:
        """Create an instance of GetRowInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetRowInput.parse_obj(obj)

        _obj = GetRowInput.parse_obj({
            "mat": obj.get("mat"),
            "row": obj.get("row")
        })
        return _obj
