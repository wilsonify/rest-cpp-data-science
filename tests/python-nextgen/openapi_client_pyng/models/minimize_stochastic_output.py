...
class MinimizeStochasticOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinimizeStochasticOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinimizeStochasticOutput:
        """Create an instance of MinimizeStochasticOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MinimizeStochasticOutput.parse_obj(obj)

        _obj = MinimizeStochasticOutput.parse_obj({
            "x": obj.get("x"),
