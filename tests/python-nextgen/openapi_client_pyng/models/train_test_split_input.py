...
class TrainTestSplitInput(BaseModel):
    ...
    y: Optional[List[List[StrictFloat]]] = None
    p: Optional[StrictFloat] = None
    __properties = ["x", "y", "p"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrainTestSplitInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrainTestSplitInput:
        """Create an instance of TrainTestSplitInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TrainTestSplitInput.parse_obj(obj)

        _obj = TrainTestSplitInput.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y"),
            "p": obj.get("p")
        })
