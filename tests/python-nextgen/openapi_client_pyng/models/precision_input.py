...
class PrecisionInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PrecisionInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PrecisionInput:
        """Create an instance of PrecisionInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PrecisionInput.parse_obj(obj)

        _obj = PrecisionInput.parse_obj({
            "tp": obj.get("tp"),
            "fp": obj.get("fp"),
            "fn": obj.get("fn"),
            "tn": obj.get("tn")
