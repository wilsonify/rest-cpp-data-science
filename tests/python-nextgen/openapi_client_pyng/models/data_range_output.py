...
class DataRangeOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataRangeOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataRangeOutput:
        """Create an instance of DataRangeOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataRangeOutput.parse_obj(obj)

        _obj = DataRangeOutput.parse_obj({
            "x": obj.get("x"),
