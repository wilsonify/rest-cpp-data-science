...
class CorrelationMatrixOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorrelationMatrixOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorrelationMatrixOutput:
        """Create an instance of CorrelationMatrixOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CorrelationMatrixOutput.parse_obj(obj)

        _obj = CorrelationMatrixOutput.parse_obj({
            "x": obj.get("x"),
