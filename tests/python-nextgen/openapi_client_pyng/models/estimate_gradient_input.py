...
class EstimateGradientInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGradientInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGradientInput:
        """Create an instance of EstimateGradientInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EstimateGradientInput.parse_obj(obj)

        _obj = EstimateGradientInput.parse_obj({
            "v": obj.get("v"),
            "h": obj.get("h")
        })
        return _obj
