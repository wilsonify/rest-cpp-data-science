...
class StandardDeviationInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StandardDeviationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StandardDeviationInput:
        """Create an instance of StandardDeviationInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return StandardDeviationInput.parse_obj(obj)

        _obj = StandardDeviationInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
