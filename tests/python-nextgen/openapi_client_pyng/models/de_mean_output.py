...
class DeMeanOutput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    result: Optional[List[StrictFloat]] = None
    __properties = ["result"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeMeanOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeMeanOutput:
        """Create an instance of DeMeanOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DeMeanOutput.parse_obj(obj)

        _obj = DeMeanOutput.parse_obj({
