...
class InRandomOrderInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    data: Optional[List[StrictFloat]] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InRandomOrderInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InRandomOrderInput:
        """Create an instance of InRandomOrderInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InRandomOrderInput.parse_obj(obj)

        _obj = InRandomOrderInput.parse_obj({
            "data": obj.get("data")
        })
        return _obj
