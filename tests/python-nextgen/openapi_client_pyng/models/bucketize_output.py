...
class BucketizeOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BucketizeOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BucketizeOutput:
        """Create an instance of BucketizeOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BucketizeOutput.parse_obj(obj)

        _obj = BucketizeOutput.parse_obj({
            "x": obj.get("x"),
