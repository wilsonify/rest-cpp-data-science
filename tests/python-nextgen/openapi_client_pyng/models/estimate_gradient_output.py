...
class EstimateGradientOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EstimateGradientOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EstimateGradientOutput:
        """Create an instance of EstimateGradientOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return EstimateGradientOutput.parse_obj(obj)

        _obj = EstimateGradientOutput.parse_obj({
            "x": obj.get("x"),
