...
class SqrtInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SqrtInput:
        """Create an instance of SqrtInput from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SqrtInput:
        """Create an instance of SqrtInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SqrtInput.parse_obj(obj)

        _obj = SqrtInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
