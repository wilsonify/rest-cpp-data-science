...
class CovarianceInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CovarianceInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CovarianceInput:
        """Create an instance of CovarianceInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CovarianceInput.parse_obj(obj)

        _obj = CovarianceInput.parse_obj({
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
