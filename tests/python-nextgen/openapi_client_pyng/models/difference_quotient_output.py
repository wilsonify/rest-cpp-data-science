...
class DifferenceQuotientOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DifferenceQuotientOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DifferenceQuotientOutput:
        """Create an instance of DifferenceQuotientOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DifferenceQuotientOutput.parse_obj(obj)

        _obj = DifferenceQuotientOutput.parse_obj({
            "x": obj.get("x"),
