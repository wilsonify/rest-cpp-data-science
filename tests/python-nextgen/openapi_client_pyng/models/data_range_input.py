...
class DataRangeInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataRangeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataRangeInput:
        """Create an instance of DataRangeInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DataRangeInput.parse_obj(obj)

        _obj = DataRangeInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
