...
class CorrelationOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CorrelationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CorrelationOutput:
        """Create an instance of CorrelationOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CorrelationOutput.parse_obj(obj)

        _obj = CorrelationOutput.parse_obj({
            "x": obj.get("x"),
