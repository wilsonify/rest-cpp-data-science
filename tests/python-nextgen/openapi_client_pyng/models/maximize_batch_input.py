...
class MaximizeBatchInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaximizeBatchInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaximizeBatchInput:
        """Create an instance of MaximizeBatchInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MaximizeBatchInput.parse_obj(obj)

        _obj = MaximizeBatchInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
