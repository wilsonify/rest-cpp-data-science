...
class DistanceOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DistanceOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DistanceOutput:
        """Create an instance of DistanceOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DistanceOutput.parse_obj(obj)

        _obj = DistanceOutput.parse_obj({
            "x": obj.get("x"),
