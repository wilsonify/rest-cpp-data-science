...
class SplitDataInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SplitDataInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SplitDataInput:
        """Create an instance of SplitDataInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SplitDataInput.parse_obj(obj)

        _obj = SplitDataInput.parse_obj({
            "data": obj.get("data")
        })
        return _obj
