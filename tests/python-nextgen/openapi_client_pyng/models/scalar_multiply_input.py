...
class ScalarMultiplyInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    c: Optional[StrictFloat] = None
    mat: Optional[List[List[StrictFloat]]] = None
    __properties = ["c", "mat"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScalarMultiplyInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScalarMultiplyInput:
        """Create an instance of ScalarMultiplyInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ScalarMultiplyInput.parse_obj(obj)

        _obj = ScalarMultiplyInput.parse_obj({
            "c": obj.get("c"),
            "mat": obj.get("mat")
        })
        return _obj
