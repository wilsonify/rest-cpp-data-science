...
class MaximizeBatchOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaximizeBatchOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaximizeBatchOutput:
        """Create an instance of MaximizeBatchOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MaximizeBatchOutput.parse_obj(obj)

        _obj = MaximizeBatchOutput.parse_obj({
            "x": obj.get("x"),
