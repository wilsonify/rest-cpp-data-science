...
class GetColumnInput(BaseModel):
    ...
    col: Optional[StrictFloat] = None
    __properties = ["mat", "col"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetColumnInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetColumnInput:
        """Create an instance of GetColumnInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetColumnInput.parse_obj(obj)

        _obj = GetColumnInput.parse_obj({
            "mat": obj.get("mat"),
            "col": obj.get("col")
        })
        return _obj
