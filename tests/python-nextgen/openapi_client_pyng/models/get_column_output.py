...
class GetColumnOutput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetColumnOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetColumnOutput:
        """Create an instance of GetColumnOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetColumnOutput.parse_obj(obj)

        _obj = GetColumnOutput.parse_obj({
            "x": obj.get("x"),
