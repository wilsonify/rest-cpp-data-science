...
class MagnitudeInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MagnitudeInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MagnitudeInput:
        """Create an instance of MagnitudeInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MagnitudeInput.parse_obj(obj)

        _obj = MagnitudeInput.parse_obj({
            "v": obj.get("v")
        })
        return _obj
