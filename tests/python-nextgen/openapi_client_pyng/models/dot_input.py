...
class DotInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DotInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DotInput:
        """Create an instance of DotInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return DotInput.parse_obj(obj)

        _obj = DotInput.parse_obj({
            "v": obj.get("v"),
            "w": obj.get("w")
        })
        return _obj
