...
class VectorSumInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorSumInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorSumInput:
        """Create an instance of VectorSumInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VectorSumInput.parse_obj(obj)

        _obj = VectorSumInput.parse_obj({
            "v": obj.get("v"),
            "w": obj.get("w")
        })
        return _obj
