...
class MatrixAddInput(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator.
    Ref: https://openapi-generator.tech

    Do not edit the class manually.
    """
    mat1: Optional[List[List[StrictFloat]]] = None
    mat2: Optional[List[List[StrictFloat]]] = None
    __properties = ["mat1", "mat2"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MatrixAddInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MatrixAddInput:
        """Create an instance of MatrixAddInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MatrixAddInput.parse_obj(obj)

        _obj = MatrixAddInput.parse_obj({
            "mat1": obj.get("mat1"),
            "mat2": obj.get("mat2")
        })
        return _obj
