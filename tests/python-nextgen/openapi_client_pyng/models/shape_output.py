...
class ShapeOutput(BaseModel):
    ...
    """
    nrows: Optional[StrictFloat] = None
    ncols: Optional[StrictFloat] = None
    __properties = ["nrows", "ncols"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShapeOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShapeOutput:
        """Create an instance of ShapeOutput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ShapeOutput.parse_obj(obj)

        _obj = ShapeOutput.parse_obj({
            "nrows": obj.get("nrows"),
            "ncols": obj.get("ncols")
        })
        return _obj
