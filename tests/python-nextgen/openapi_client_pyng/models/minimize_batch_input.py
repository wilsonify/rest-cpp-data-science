...
class MinimizeBatchInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MinimizeBatchInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MinimizeBatchInput:
        """Create an instance of MinimizeBatchInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MinimizeBatchInput.parse_obj(obj)

        _obj = MinimizeBatchInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
