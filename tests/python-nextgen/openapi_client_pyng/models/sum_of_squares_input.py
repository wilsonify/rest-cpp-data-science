...
class SumOfSquaresInput(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SumOfSquaresInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SumOfSquaresInput:
        """Create an instance of SumOfSquaresInput from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SumOfSquaresInput.parse_obj(obj)

        _obj = SumOfSquaresInput.parse_obj({
            "x": obj.get("x")
        })
        return _obj
