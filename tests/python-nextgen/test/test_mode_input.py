...
from openapi_client_pyng.models.mode_input import ModeInput  # noqa: E501
from openapi_client_pyng.rest import ApiException

class TestModeInput(unittest.TestCase):
    """ModeInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `ModeInput`
        """
        model = openapi_client_pyng.models.mode_input.ModeInput()  # noqa: E501
        if include_optional :
            return ModeInput(
                x = [
                    1.337
