...
from openapi_client_pyng.models.mean_input import MeanInput  # noqa: E501
from openapi_client_pyng.rest import ApiException

class TestMeanInput(unittest.TestCase):
    """MeanInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `MeanInput`
        """
        model = openapi_client_pyng.models.mean_input.MeanInput()  # noqa: E501
        if include_optional :
            return MeanInput(
                x = [
                    1.337
