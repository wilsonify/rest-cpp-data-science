...
from openapi_client_pyng.models.dot_output import DotOutput  # noqa: E501
from openapi_client_pyng.rest import ApiException

class TestDotOutput(unittest.TestCase):
    """DotOutput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `DotOutput`
        """
        model = openapi_client_pyng.models.dot_output.DotOutput()  # noqa: E501
        if include_optional :
            return DotOutput(
                x = 1.337, 
                result = 1.337
