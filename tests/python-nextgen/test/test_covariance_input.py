...
from openapi_client_pyng.models.covariance_input import CovarianceInput  # noqa: E501
from openapi_client_pyng.rest import ApiException

class TestCovarianceInput(unittest.TestCase):
    """CovarianceInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CovarianceInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CovarianceInput`
        """
        model = openapi_client_pyng.models.covariance_input.CovarianceInput()  # noqa: E501
        if include_optional :
