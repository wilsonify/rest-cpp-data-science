...
from openapi_client_pyng.models.dot_input import DotInput  # noqa: E501
from openapi_client_pyng.rest import ApiException

class TestDotInput(unittest.TestCase):
    """DotInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `DotInput`
        """
        model = openapi_client_pyng.models.dot_input.DotInput()  # noqa: E501
        if include_optional :
            return DotInput(
                v = [
                    1.337
