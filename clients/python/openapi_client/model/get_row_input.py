...
class GetRowInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mat", "row", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mat", "row", ], str]):
