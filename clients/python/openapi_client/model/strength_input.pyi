...
class StrengthInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["actual", "expected", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["actual", "expected", ], str]):
