...
class DifferenceQuotientInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["x", "h", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["x", "h", ], str]):
