...
class ScalarMultiplyInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["c", "mat", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["c", "mat", ], str]):
