...
class EstimateGradientInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["v", "h", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["v", "h", ], str]):
