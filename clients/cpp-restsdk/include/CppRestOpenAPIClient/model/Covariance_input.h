...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Covariance_input_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Covariance_input_H_
...
/// 
/// </summary>
class  Covariance_input
    : public ModelBase
{
public:
    Covariance_input();
    virtual ~Covariance_input();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Covariance_input_H_ */
