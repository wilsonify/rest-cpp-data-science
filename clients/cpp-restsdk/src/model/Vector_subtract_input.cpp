...
Vector_subtract_input::Vector_subtract_input()
{
    m_vIsSet = false;
    m_wIsSet = false;
}
...
void Vector_subtract_input::validate()
{
    // TODO: implement validation
}

web::json::value Vector_subtract_input::toJson() const
{
...
bool Vector_subtract_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Vector_subtract_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Vector_subtract_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Vector_subtract_input::getV()
{
    return m_v;
}

void Vector_subtract_input::setV(std::vector<double> value)
{
    m_v = value;
    m_vIsSet = true;
}

bool Vector_subtract_input::VIsSet() const
{
    return m_vIsSet;
}

void Vector_subtract_input::unsetv()
{
    m_vIsSet = false;
}
std::vector<double>& Vector_subtract_input::getW()
{
    return m_w;
}

void Vector_subtract_input::setW(std::vector<double> value)
{
    m_w = value;
    m_wIsSet = true;
}

bool Vector_subtract_input::WIsSet() const
{
    return m_wIsSet;
}

void Vector_subtract_input::unsetw()
{
    m_wIsSet = false;
}
}
