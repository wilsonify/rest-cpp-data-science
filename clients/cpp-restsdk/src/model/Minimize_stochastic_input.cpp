...
Minimize_stochastic_input::Minimize_stochastic_input()
{
    m_xIsSet = false;
    m_yIsSet = false;
}
...
void Minimize_stochastic_input::validate()
{
    // TODO: implement validation
}

web::json::value Minimize_stochastic_input::toJson() const
{
...
bool Minimize_stochastic_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Minimize_stochastic_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Minimize_stochastic_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::vector<double>>& Minimize_stochastic_input::getX()
{
    return m_x;
}

void Minimize_stochastic_input::setX(const std::vector<std::vector<double>>& value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Minimize_stochastic_input::XIsSet() const
{
    return m_xIsSet;
}

void Minimize_stochastic_input::unsetx()
{
    m_xIsSet = false;
}
std::vector<double>& Minimize_stochastic_input::getY()
{
    return m_y;
}

void Minimize_stochastic_input::setY(std::vector<double> value)
{
    m_y = value;
    m_yIsSet = true;
}

bool Minimize_stochastic_input::YIsSet() const
{
    return m_yIsSet;
}

void Minimize_stochastic_input::unsety()
{
    m_yIsSet = false;
}
}
