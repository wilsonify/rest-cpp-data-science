...
void Dot_input::validate()
{
    // TODO: implement validation
}

web::json::value Dot_input::toJson() const
{
...
bool Dot_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dot_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dot_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Dot_input::getV()
{
    return m_v;
}

void Dot_input::setV(std::vector<double> value)
{
    m_v = value;
    m_vIsSet = true;
}

bool Dot_input::VIsSet() const
{
    return m_vIsSet;
}

void Dot_input::unsetv()
{
    m_vIsSet = false;
}
std::vector<double>& Dot_input::getW()
{
    return m_w;
}

void Dot_input::setW(std::vector<double> value)
{
    m_w = value;
    m_wIsSet = true;
}

bool Dot_input::WIsSet() const
{
    return m_wIsSet;
}

void Dot_input::unsetw()
{
    m_wIsSet = false;
}
}
