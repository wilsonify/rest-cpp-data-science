...
void Get_row_output::validate()
{
    // TODO: implement validation
}

web::json::value Get_row_output::toJson() const
{
...
bool Get_row_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_row_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_row_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Get_row_output::getX() const
{
    return m_x;
}

void Get_row_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Get_row_output::XIsSet() const
{
    return m_xIsSet;
}

void Get_row_output::unsetx()
{
    m_xIsSet = false;
}
double Get_row_output::getResult() const
{
    return m_Result;
}

void Get_row_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Get_row_output::resultIsSet() const
{
    return m_ResultIsSet;
}

void Get_row_output::unsetResult()
{
    m_ResultIsSet = false;
}
}
