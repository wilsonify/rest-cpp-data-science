...
web::json::value Sqrt_input::toJson() const
{
...
bool Sqrt_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Sqrt_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Sqrt_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void Sqrt_input::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}
