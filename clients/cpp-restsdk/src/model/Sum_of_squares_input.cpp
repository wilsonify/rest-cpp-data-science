...
void Sum_of_squares_input::validate()
{
    // TODO: implement validation
}

web::json::value Sum_of_squares_input::toJson() const
{
...
bool Sum_of_squares_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Sum_of_squares_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Sum_of_squares_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Sum_of_squares_input::getX()
{
    return m_x;
}

void Sum_of_squares_input::setX(std::vector<double> value)
{
    m_x = value;
    m_xIsSet = true;
}
