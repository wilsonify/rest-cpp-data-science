...
Minimize_batch_output::Minimize_batch_output()
{
    m_x = 0.0;
    m_xIsSet = false;
    m_Result = 0.0;
...
void Minimize_batch_output::validate()
{
    // TODO: implement validation
}

web::json::value Minimize_batch_output::toJson() const
{
...
bool Minimize_batch_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Minimize_batch_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Minimize_batch_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Minimize_batch_output::getX() const
{
    return m_x;
}

void Minimize_batch_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Minimize_batch_output::XIsSet() const
{
    return m_xIsSet;
}

void Minimize_batch_output::unsetx()
{
    m_xIsSet = false;
}
double Minimize_batch_output::getResult() const
{
    return m_Result;
}

void Minimize_batch_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Minimize_batch_output::resultIsSet() const
{
    return m_ResultIsSet;
}

void Minimize_batch_output::unsetResult()
{
    m_ResultIsSet = false;
}
}
