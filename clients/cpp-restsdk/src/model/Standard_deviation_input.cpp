...
void Standard_deviation_input::validate()
{
    // TODO: implement validation
}

web::json::value Standard_deviation_input::toJson() const
{
...
bool Standard_deviation_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Standard_deviation_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Standard_deviation_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Standard_deviation_input::getX()
{
    return m_x;
}

void Standard_deviation_input::setX(std::vector<double> value)
{
    m_x = value;
    m_xIsSet = true;
}
