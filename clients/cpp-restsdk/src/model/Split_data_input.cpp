...
void Split_data_input::validate()
{
    // TODO: implement validation
}

web::json::value Split_data_input::toJson() const
{
...
bool Split_data_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Split_data_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Split_data_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::vector<double>>& Split_data_input::getData()
{
    return m_Data;
}

void Split_data_input::setData(const std::vector<std::vector<double>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}
