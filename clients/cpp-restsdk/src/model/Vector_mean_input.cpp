...
Vector_mean_input::Vector_mean_input()
{
    m_vIsSet = false;
    m_wIsSet = false;
}
...
void Vector_mean_input::validate()
{
    // TODO: implement validation
}

web::json::value Vector_mean_input::toJson() const
{
...
bool Vector_mean_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Vector_mean_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Vector_mean_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Vector_mean_input::getV()
{
    return m_v;
}

void Vector_mean_input::setV(std::vector<double> value)
{
    m_v = value;
    m_vIsSet = true;
}

bool Vector_mean_input::VIsSet() const
{
    return m_vIsSet;
}

void Vector_mean_input::unsetv()
{
    m_vIsSet = false;
}
std::vector<double>& Vector_mean_input::getW()
{
    return m_w;
}

void Vector_mean_input::setW(std::vector<double> value)
{
    m_w = value;
    m_wIsSet = true;
}

bool Vector_mean_input::WIsSet() const
{
    return m_wIsSet;
}

void Vector_mean_input::unsetw()
{
    m_wIsSet = false;
}
}
