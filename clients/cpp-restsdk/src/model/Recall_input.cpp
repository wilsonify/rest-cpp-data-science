...
void Recall_input::validate()
{
    // TODO: implement validation
}

web::json::value Recall_input::toJson() const
{
...
bool Recall_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Recall_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Recall_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void Recall_input::setTp(double value)
{
    m_Tp = value;
    m_TpIsSet = true;
}
...
void Recall_input::setFp(double value)
{
    m_Fp = value;
    m_FpIsSet = true;
}
...
void Recall_input::setFn(double value)
{
    m_Fn = value;
    m_FnIsSet = true;
}
...
void Recall_input::setTn(double value)
{
    m_Tn = value;
    m_TnIsSet = true;
}
