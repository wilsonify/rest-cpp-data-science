...
Maximize_stochastic_output::Maximize_stochastic_output()
{
    m_x = 0.0;
    m_xIsSet = false;
    m_Result = 0.0;
...
void Maximize_stochastic_output::validate()
{
    // TODO: implement validation
}

web::json::value Maximize_stochastic_output::toJson() const
{
...
bool Maximize_stochastic_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Maximize_stochastic_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Maximize_stochastic_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Maximize_stochastic_output::getX() const
{
    return m_x;
}

void Maximize_stochastic_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Maximize_stochastic_output::XIsSet() const
{
    return m_xIsSet;
}

void Maximize_stochastic_output::unsetx()
{
    m_xIsSet = false;
}
double Maximize_stochastic_output::getResult() const
{
    return m_Result;
}

void Maximize_stochastic_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Maximize_stochastic_output::resultIsSet() const
{
    return m_ResultIsSet;
}

void Maximize_stochastic_output::unsetResult()
{
    m_ResultIsSet = false;
}
}
