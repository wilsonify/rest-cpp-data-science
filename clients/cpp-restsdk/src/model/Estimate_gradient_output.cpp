...
void Estimate_gradient_output::validate()
{
    // TODO: implement validation
}

web::json::value Estimate_gradient_output::toJson() const
{
...
bool Estimate_gradient_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Estimate_gradient_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Estimate_gradient_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
void Estimate_gradient_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}
...
void Estimate_gradient_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}
