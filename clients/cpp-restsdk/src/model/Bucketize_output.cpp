...
Bucketize_output::Bucketize_output()
{
    m_x = 0.0;
    m_xIsSet = false;
    m_Result = 0.0;
...
void Bucketize_output::validate()
{
    // TODO: implement validation
}

web::json::value Bucketize_output::toJson() const
{
...
bool Bucketize_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Bucketize_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Bucketize_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Bucketize_output::getX() const
{
    return m_x;
}

void Bucketize_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Bucketize_output::XIsSet() const
{
    return m_xIsSet;
}

void Bucketize_output::unsetx()
{
    m_xIsSet = false;
}
double Bucketize_output::getResult() const
{
    return m_Result;
}

void Bucketize_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Bucketize_output::resultIsSet() const
{
    return m_ResultIsSet;
}

void Bucketize_output::unsetResult()
{
    m_ResultIsSet = false;
}
}
