...
void Vector_sum_input::validate()
{
    // TODO: implement validation
}

web::json::value Vector_sum_input::toJson() const
{
...
bool Vector_sum_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Vector_sum_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Vector_sum_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<double>& Vector_sum_input::getV()
{
    return m_v;
}

void Vector_sum_input::setV(std::vector<double> value)
{
    m_v = value;
    m_vIsSet = true;
}
...
std::vector<double>& Vector_sum_input::getW()
{
    return m_w;
}

void Vector_sum_input::setW(std::vector<double> value)
{
    m_w = value;
    m_wIsSet = true;
}
