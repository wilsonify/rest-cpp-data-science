...
void Dot_output::validate()
{
    // TODO: implement validation
}

web::json::value Dot_output::toJson() const
{
...
bool Dot_output::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dot_output::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dot_output::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Dot_output::getX() const
{
    return m_x;
}

void Dot_output::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Dot_output::XIsSet() const
{
    return m_xIsSet;
}

void Dot_output::unsetx()
{
    m_xIsSet = false;
}
double Dot_output::getResult() const
{
    return m_Result;
}

void Dot_output::setResult(double value)
{
    m_Result = value;
    m_ResultIsSet = true;
}

bool Dot_output::resultIsSet() const
{
    return m_ResultIsSet;
}

void Dot_output::unsetResult()
{
    m_ResultIsSet = false;
}
}
