...
Minimize_batch_input::Minimize_batch_input()
{
    m_x = 0.0;
    m_xIsSet = false;
}
...
void Minimize_batch_input::validate()
{
    // TODO: implement validation
}

web::json::value Minimize_batch_input::toJson() const
{
...
bool Minimize_batch_input::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Minimize_batch_input::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Minimize_batch_input::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Minimize_batch_input::getX() const
{
    return m_x;
}

void Minimize_batch_input::setX(double value)
{
    m_x = value;
    m_xIsSet = true;
}

bool Minimize_batch_input::XIsSet() const
{
    return m_xIsSet;
}

void Minimize_batch_input::unsetx()
{
    m_xIsSet = false;
}
}
